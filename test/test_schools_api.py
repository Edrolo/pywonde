...
class TestSchoolsApi(unittest.TestCase):
    ...
    def test_get_school_acl(self) -> None:
    ...
    def test_get_school_meta(self) -> None:
    ...
    def test_get_school_permissions(self) -> None:
    ...
    def test_list_schools_approved(self) -> None:
    ...
    def test_list_schools_audited(self) -> None:
    ...
    def test_list_schools_declined(self) -> None:
    ...
    def test_list_schools_offline(self) -> None:
    ...
    def test_list_schools_pending(self) -> None:
    ...
    def test_list_schools_revoked(self) -> None:
    ...
    def test_request_school_access(self) -> None:
    ...
    def test_revoke_school_access(self) -> None:
