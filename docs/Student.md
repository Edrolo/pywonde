...
**title** | **str** | The student’s title. | [optional] 
...
**gender** | **str** | The student’s gender. Documented values: male, female, intersex or indeterminate, not stated/inadequately described, redacted for privacy, other.  | [optional] 
**gender_identity** | **str** | The student’s gender identity — their inner concept of self as male, female, neither or a blend of both, per DfE guidance.  | [optional] 
