...
class ClassesApi:
    ...
    def get_school_class(
        ...
        _param = self._get_school_class_serialize(
            school_id=school_id,
            class_id=class_id,
            include=include,
    ...
    def get_school_class_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetSchoolClass200Response]:
        """Get specific class for a school
    ...
    @validate_call
    def get_school_class_without_preload_content(
        self,
        school_id: Annotated[StrictStr, Field(description='The ID of the school')],
        class_id: Annotated[StrictStr, Field(description='The ID of the class')],
        include: Annotated[
    ...
    def _get_school_class_serialize(
        self,
        school_id,
        class_id,
        include,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/schools/{school_id}/classes/{class_id}',
    ...
    def list_school_classes(
        ...
        type: Annotated[
            Optional[StrictStr],
            Field(
                description='Comma-separated list of class types to return. Australia region values: academic, duty, extra curricular, on call, roll class, rostered time off, staff meeting, study. '
            ),
        ] = None,
        _request_timeout: Union[
            None,
        ...
        :param type: Comma-separated list of class types to return. Australia region values: academic, duty, extra curricular, on call, roll class, rostered time off, staff meeting, study.
        :type type: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._list_school_classes_serialize(
            school_id=school_id,
    ...
    def list_school_classes_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListSchoolClasses200Response]:
        """Get all classes for a school
    ...
    @validate_call
    def list_school_classes_without_preload_content(
        self,
        school_id: Annotated[StrictStr, Field(description='The ID of the school')],
        updated_after: Annotated[
            Optional[date], Field(description='Return rows modified after date')
    ...
    def _list_school_classes_serialize(
        self,
        school_id,
        updated_after,
        updated_before,
        ...
        if has_lessons is not None:
            ...
            _query_params.append(('has_lessons', has_lessons))
        ...
        if class_subject is not None:
            ...
            _query_params.append(('class_subject', class_subject))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/schools/{school_id}/classes',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
