...
class StudentsApi:
    ...
    def get_school_student(
        ...
        student_id: Annotated[StrictStr, Field(description='The ID of the student to retrieve')],
        ...
        _param = self._get_school_student_serialize(
            school_id=school_id,
    ...
    @validate_call
    def get_school_student_without_preload_content(
        self,
        school_id: Annotated[
            StrictStr, Field(description='The ID of the school to retrieve the student from')
        ],
    ...
    def _get_school_student_serialize(
        self,
        school_id,
        student_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/schools/{school_id}/students/{student_id}',
    ...
    def list_school_students(
        ...
        _param = self._list_school_students_serialize(
            school_id=school_id,
    ...
    def list_school_students_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListSchoolStudents200Response]:
        """Retrieve a list of students for a specific school
    ...
    @validate_call
    def list_school_students_without_preload_content(
        self,
        school_id: Annotated[StrictStr, Field(description='The ID of the school.')],
        updated_after: Annotated[
            Optional[date], Field(description='Return rows modified after date')
    ...
    def _list_school_students_serialize(
        self,
        school_id,
        updated_after,
        updated_before,
        ...
        if aspect_id is not None:
            ...
            _query_params.append(('aspect_id', aspect_id))
        ...
        if only_upns is not None:

            _query_params.append(('only_upns', only_upns))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/schools/{school_id}/students',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
