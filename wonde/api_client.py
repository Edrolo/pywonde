...
import wonde.models
from wonde import rest
from wonde.api_response import ApiResponse
from wonde.api_response import T as ApiResponseT
from wonde.configuration import Configuration
from wonde.exceptions import (
    ApiException,
    ApiValueError,
)
...
class ApiClient:
    ...
    def response_deserialize(
        ...
        if (
            ...
            and str(response_data.status) not in response_types_map
            and (
                not isinstance(response_data.status, int)
                or not 100 <= response_data.status <= 599
                or str(response_data.status)[0] + 'XX' not in response_types_map
            )
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(wonde.models, klass)
