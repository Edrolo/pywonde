...
class SchoolsSchoolIdClassesClassIdGet200Response(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SchoolsSchoolIdClassesClassIdGet200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SchoolsSchoolIdClassesClassIdGet200Response:
        """Create an instance of SchoolsSchoolIdClassesClassIdGet200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SchoolsSchoolIdClassesClassIdGet200Response.parse_obj(obj)

        _obj = SchoolsSchoolIdClassesClassIdGet200Response.parse_obj(
            {
                'data': ModelClass.from_dict(obj.get('data'))
