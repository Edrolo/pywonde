...
class SchoolsAllGet200Response(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SchoolsAllGet200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SchoolsAllGet200Response:
        """Create an instance of SchoolsAllGet200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SchoolsAllGet200Response.parse_obj(obj)

        _obj = SchoolsAllGet200Response.parse_obj(
            {
                'data': [School.from_dict(_item) for _item in obj.get('data')]
