...
class GetSchoolLessons200ResponseMeta(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetSchoolLessons200ResponseMeta:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetSchoolLessons200ResponseMeta:
        """Create an instance of GetSchoolLessons200ResponseMeta from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetSchoolLessons200ResponseMeta.parse_obj(obj)

        _obj = GetSchoolLessons200ResponseMeta.parse_obj(
            {
