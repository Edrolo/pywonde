...
class GetSchoolAcl200Response(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetSchoolAcl200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetSchoolAcl200Response:
        """Create an instance of GetSchoolAcl200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetSchoolAcl200Response.parse_obj(obj)

        _obj = GetSchoolAcl200Response.parse_obj(
