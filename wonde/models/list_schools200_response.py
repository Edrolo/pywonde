...
class ListSchools200Response(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListSchools200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListSchools200Response:
        """Create an instance of ListSchools200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListSchools200Response.parse_obj(obj)

        _obj = ListSchools200Response.parse_obj(
            {
