...
class RequestSchoolAccessRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RequestSchoolAccessRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RequestSchoolAccessRequest:
        """Create an instance of RequestSchoolAccessRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RequestSchoolAccessRequest.parse_obj(obj)

        _obj = RequestSchoolAccessRequest.parse_obj(
            {
