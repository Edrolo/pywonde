...
class GetSubjects200Response(BaseModel):
    """
    GetSubjects200Response
    """

    data: conlist(Subject) | None = None
    meta: Meta | None = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetSubjects200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetSubjects200Response:
        """Create an instance of GetSubjects200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetSubjects200Response.parse_obj(obj)

        _obj = GetSubjects200Response.parse_obj(
            {
